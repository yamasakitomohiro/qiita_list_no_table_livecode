...
@interface HMTableView : UIScrollView
@property (nonatomic, weak) id <HMTableViewDelegate> __nullable myDelegate;
@property (nonatomic) NSInteger _cellNum;
@property (nonatomic, readonly) CGFloat CELL_HEIGHT;
...
@interface QiitaViewModel : NSObject
...
- (void)loadView;
- (void)viewDidLoad;
- (void)tableUpdate:(UIRefreshControl * __nullable)sender;
- (void)tableView:(HMTableView * __nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * __nonnull)indexPath;
